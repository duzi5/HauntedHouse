 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight('#b9d5ff', 0.015)
...
const tick = () =>
{
    ...
    ghost1.position.y = (Math.sin(ghost1Angle) * 3) + Math.sin(elapsedTime * 2.5)
    ...
    ghost3.position.y = Math.sin(ghost3Angle) * 5
